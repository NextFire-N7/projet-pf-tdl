...
Ce projet constitue en l'extension du compilateur RAT \(\to\)
TAM développé lors des scéances de Traduction des Langages.
...
ont été rajouter pour désigner respectivement une structure et un champ.
...
\texttt{analyse\_tds\_type} défini précédemment qui se charge de
